...
const ProofModal = ({ show, setShowModal, imageProof, txnId }) => {
  const { darkMode } = useTheme();
  const modalBgClass = darkMode ? "bg-dark text-light" : "bg-white text-dark";
            ...
            <>
              <img
                ...
                style={{
                  ...
                  objectFit: "contain",
                  borderRadius: "8px",
                  border: `2px solid ${darkMode ? "#ffffff44" : "#00000022"}`,
                }}
              />
              {!isLoading && (
